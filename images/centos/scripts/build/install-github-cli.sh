...
if [[ "$ARCH" == "ppc64le" ]]; then 
    ...
    # Download GitHub CLI
    gh_cli_url=$(resolve_github_release_asset_url "cli/cli" "contains(\"linux\") and contains(\"amd64\") and endswith(\".rpm\")" "latest")
    ...
    external_hash=$(get_checksum_from_url "$hash_url" "linux_amd64.rpm" "SHA256")
